            ...
            <div className="wrapper">
              <div className="col1-start col-1end">
                ...
                <p className="paddingtop30">
                  The world has come to the point when technology becomes a part of our lives and exists everywhere.
                  While the concepts of HCI mainly focus on humans and computers, having a focal point toward specific 
                  stakeholders may result in the exclusion of others. To shift the focus away from 
                  “humans” and “computers” toward things around us, I had proposed a concept of interactive art that enhances 
                ...
                <p className="paddingtop30">
                  ...
                  “Color of Nature” tangible interactive art referenced from various research papers. The idea of this art was 
                  inspired by the differences in natural colors and synthetic colors. I created the Color of Nature with a goal 
                ...
                <p className="paddingtop30">
                  To encourage people's interaction with the environment, I came up with the idea of using a hand glove to make a 
