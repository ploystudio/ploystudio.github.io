...
export default class HmongEmbroidery extends Component {
  componentDidMount(){
    document.title = "Learn the Heart of Hmong Culture through Hmong Embroidery | Ploy Pruekcharoen"
  }
  render() {
    return (
      <div>
        ...
        <div className="column-left project-column">
            ...
            <p>
              Research/Writing
              <ol>
                <li><a href="/hmongembroidery" className="current-page">Learn the Heart of Hmong Culture through Hmong Embroidery</a></li>
